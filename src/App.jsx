...
import './index.css'; 
import fotoPerfil from './assets/leticia.jpeg';
...
function App() {
  ...
  return (
    <div className={`${temaEscuro ? 'dark-theme' : ''}`} style={{ minHeight: '100vh' }}>
      ...
      <main>
        ...
        <section id="sobre">
           ...
           <img src={fotoPerfil} alt="Foto de Letícia" />
            <p>Sou formada em Licenciatura em computação e atualmente sou professora de desenvolvimento de sistemas e apaixonada pela tecnologia.</p>
        </section>
      ...
      <footer>
        <p>&copy; 2026 - Desenvolvido por Letícia Maria</p>
      </footer>
    </div>
  );
}
